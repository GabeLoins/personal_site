...
var flavorText = {
  ...
  'tripadvisor':"After my Freshman year, I interned on the mobile-web team at TripAdvisor. Here is my branded TripAdvisor mug that (regrettably) fell off the back of a micro-kitchen. During the summer, I shipped an image carousel that substantially increased engagement but caused Apple to threaten legal action. Later, my team won first in the intern hackathon for detecting whether an eatery was best for Breakfast, Lunch, Dinner or Brunch using check-in data.",
